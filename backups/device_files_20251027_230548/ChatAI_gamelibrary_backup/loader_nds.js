...
(function() {
    ...
    window.EJS_biosUrl = `http://${serverIP}:8888/gamedata/data/bios/bios7.bin`;
    window.EJS_bios9Url = `http://${serverIP}:8888/gamedata/data/bios/bios9.bin`;
    window.EJS_firmwareUrl = `http://${serverIP}:8888/gamedata/data/bios/firmware.bin`;
    ...
    fetch(`http://${serverIP}:8888/gamedata/nds/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:8888/gamedata/nds/${gameFile}`;
            const loaderScript = document.createElement('script');
            loaderScript.src = `http://${serverIP}:8888/gamedata/data/loader.js`;
            document.body.appendChild(loaderScript);
        })
