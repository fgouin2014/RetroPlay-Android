// ATARI 2600 Loader Configuration
(function() {
    ...
    fetch(`http://${serverIP}:7777/gamedata/atari2600/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:7777/gamedata/atari2600/${gameFile}`;
            const loaderScript = document.createElement('script');
            loaderScript.src = `http://${serverIP}:7777/gamedata/data/loader.js`;
            document.body.appendChild(loaderScript);
        })
