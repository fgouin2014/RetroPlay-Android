// PC Engine Loader Configuration
(function() {
    ...
    window.EJS_biosUrl = `http://${serverIP}:7777/gamedata/data/bios/syscard3.pce`;
    ...
    fetch(`http://${serverIP}:7777/gamedata/pce/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:7777/gamedata/pce/${gameFile}`;
            const loaderScript = document.createElement('script');
            loaderScript.src = `http://${serverIP}:7777/gamedata/data/loader.js`;
            document.body.appendChild(loaderScript);
        })
