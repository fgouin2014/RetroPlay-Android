// WonderSwan Loader Configuration
(function() {
    ...
    window.EJS_core = "mednafen_wswan";
    ...
    fetch(`http://${serverIP}:8888/gamedata/ws/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:8888/gamedata/ws/${gameFile}`;
            const loaderScript = document.createElement('script');
            loaderScript.src = `http://${serverIP}:8888/gamedata/data/loader.js`;
            document.body.appendChild(loaderScript);
        })
