...
/**
 * ConsoleNameMapper - Système centralisé de mapping des noms alternatifs de
 * consoles
 * 
 * Normalise tous les noms alternatifs (NES/FC, SNES/SFC, Genesis/Mega Drive,
 * etc.)
 * vers un ID canonique unique pour chaque console.
 * 
 * Suit "Nos Rules": Mapping complet basé sur les conventions
 * RetroArch/Libretro.
 */
public class ConsoleNameMapper {
    ...
    private static void initializeMappings() {
        ...
        // Arcade / MAME
        // Note: arcade et mame sont gardés séparés car ils ont des configurations
        // différentes
