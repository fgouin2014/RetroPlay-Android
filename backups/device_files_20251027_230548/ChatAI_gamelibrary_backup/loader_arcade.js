// Arcade Loader Configuration - OPTIMIZED
(function() {
    ...
    // Utiliser le core spécifié ou fbneo par défaut (meilleure compatibilité)
    window.EJS_core = coreParam || "fbneo";
    ...
    fetch(`http://${serverIP}:8888/gamedata/arcade/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:8888/gamedata/arcade/${gameFile}`;
            const loaderScript = document.createElement('script');
            loaderScript.src = `http://${serverIP}:8888/gamedata/data/loader.js`;
            document.body.appendChild(loaderScript);
        })
