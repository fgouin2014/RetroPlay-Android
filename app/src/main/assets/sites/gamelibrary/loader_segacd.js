...
(function() {
    ...
    window.EJS_biosUrl = `http://${serverIP}:7777/gamedata/data/bios/bios_CD_U.bin`;
    ...
    if (gameUrl) {
        ...
        const segaControlUrl = `http://${serverIP}:7777/gamelibrary/segacontrol.js`;
    ...
    fetch(`http://${serverIP}:7777/gamedata/segacd/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:7777/gamedata/segacd/${gameFile}`;
