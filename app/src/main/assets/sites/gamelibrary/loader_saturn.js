// Sega Saturn Loader Configuration
(function() {
    ...
    window.EJS_biosUrl = `http://${serverIP}:7777/gamedata/data/bios/saturn_bios.bin`;
    ...
    fetch(`http://${serverIP}:7777/gamedata/saturn/gamelist.json`)
        ...
        .then(data => {
            ...
            window.EJS_gameUrl = `http://${serverIP}:7777/gamedata/saturn/${gameFile}`;
            const loaderScript = document.createElement('script');
            loaderScript.src = `http://${serverIP}:7777/gamedata/data/loader.js`;
            document.body.appendChild(loaderScript);
        })
