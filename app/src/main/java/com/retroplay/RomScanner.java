...
public class RomScanner {
    ...
    /**
     * Scanner automatiquement les ROMs dans un répertoire (console custom sans
     * gamelist.json)
     */
    public static List<Game> scanRomsInDirectory(String consoleName) {
        // ROMs sont maintenant dans /roms/{console}/
        String consolePath = "/storage/emulated/0/GameLibrary-Data/roms/" + consoleName;
